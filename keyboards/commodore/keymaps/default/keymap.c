...
[CKEY] = KEYMAP(
		...
		KC_F11,  			KC_PSCR,             	KC_RGHT,       				KC_VOLD,           		KC_VOLU,           		KC_LCBR,             	KC_SLCK,   			KC_F12,   		____,		\
		____,    			KC_NLCK,             	KC_RCBR,       				KC_MUTE,           		____,              		____,                	KC_PGUP,   			KC_END,   		____,	  	\
		KC_INS,  			____,                	KC_LEFT,       				KC_UP,             		TO(C64),            	TO(C128),             	TO(PETBUS),			TO(PETGRAPH),	____,	   	\
...
[PETGRAPH_C] = KEYMAP(
		...
		____,     			____,               	____,         				____,                 	____,                 	____,           		____,      			C(KC_F7),       ____,      	\
		____,				____,                	____,          				____,              		____,																				____),
...
//Enable red, green and blue LEDS for Arduino Leonardo and Micro
//Enable Tx and Rx LEDs for ProMicro.
