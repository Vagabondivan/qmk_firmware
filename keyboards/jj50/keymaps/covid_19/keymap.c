...
[_QWERTY] = LAYOUT(	    \
	...
	PROGRAM,    KC_LCTL,    KC_LALT,	KC_LGUI,    LOWER,      KC_SPC,     KC_SPC,     RAISE,      KC_LEFT,	KC_DOWN,   KC_UP,		KC_RGHT\
),
...
[_GAMING] = LAYOUT(	    \
	...
	PROGRAM,        KC_LCTL,	KC_LALT,	KC_RCTL,    LOWER,      KC_SPC,     KC_SPC,     RAISE,      KC_RALT,	KC_LEFT,    KC_DOWN,    KC_RGHT\
),
...
[_NUMPAD] = LAYOUT(	    \
	...
	KC_NO,          KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,    KC_NO,    KC_P1,		KC_P2,		KC_P3,		KC_PPLS,	LALT(KC_PMNS),\
	KC_NO,          KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,    KC_NO,    KC_P0,		DBLOO,      KC_PDOT,	KC_PMNS,	KC_PEQL,\
	PROGRAM,        KC_LCTL,    KC_LALT,    KC_LGUI,    LOWER,      KC_SPC,   KC_SPC,   RAISE,      KC_LEFT,	KC_DOWN,    KC_UP,		KC_RGHT\
),
...
[_LOWER] = LAYOUT(	    \
    ...
    RGB_VAD,	RGB_SAD,	RGB_HUD,	KC_BRID,	LOWER,      KC_SPC,     KC_SPC,     RAISE,      RGB_M_R,	RGB_M_G,	RGB_M_B,	RGB_M_P\
),
...
[_RAISE] = LAYOUT(	    \
    ...
    KC_WBAK,    KC_WHOM,	KC_WFWD,	KC_SLCK,    LOWER,      KC_NO,      KC_NO,      RAISE,      SGUI(KC_3),     KC_MPRV,    KC_VOLD,    KC_MNXT\
),
 ...
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * |      |      |      |      |Lower |    VADER    |Raise |MSW DN| MS L | MS D | MS R |
 * `-----------------------------------------------------------------------------------'
 */
[_PROGRAM] = LAYOUT(	    \
	KC_TILD,    KC_NO,      MAIL,       KC_NO,      EURO,       KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_DEL,\
    KC_NO,      KC_NO,      KC_NO,      ACCENTE,	KC_NO,      KC_NO,      KC_NO,      ACCENTU,	ACCENTI,	ACCENTO,	KC_NO,      LALT(KC_GRV),\
    ...
    KC_NO,      KC_NO,      KC_NO,      KC_NO,  	LOWER,      VADER,      VADER,      RAISE,      KC_WH_D,	KC_MS_L,	KC_MS_D,	KC_MS_R\
),
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    switch (keycode) {
        ...
        case MAIL:  // Write your email address
            ...
            return false;
            break;
        case VADER: // Dark Side Always Present
            if (record->event.pressed) {
                SEND_STRING("You don't know the power of the Dark Side!");
            }
            return false;
            break;
