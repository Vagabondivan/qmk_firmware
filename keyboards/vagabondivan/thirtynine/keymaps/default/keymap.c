/* Default - Copyright 2025 Vagabondivan
 *
...
[_FN] = LAYOUT_ortho_4x10uC(
 ...
 `--------------------------------------------------------------------*/
  ...
  KC_LSFT,  KC_EQL,   KC_BSLS,  TD(OPNBR),  KC_1,     KC_0,     TD(CLSBR),  KC_MINS,  KC_PLUS,  KC_SLSH,
...
[_LOWER] = LAYOUT_ortho_4x10uC(
 ...
 |      |      |      |      |      |      |      | MSBL | MSBR |      |
 |------+------+------+------+------+------+------+------+------+------|
 |      |      |      |      |      |      | MSWL |MSW DN|MSW UP| MSWR |
 |------+------+------+------+------+------+------+------+------+------|
 |      |      |  ADJ |      |      ~      | MS L | MS D | MS U | MS R |
 `--------------------------------------------------------------------*/

  KC_ESC,  KC_NO,  KC_NO,   KC_NO,  KC_NO,   KC_NO,  KC_NO,       KC_NO,       KC_NO,       KC_DEL,
  KC_NO,   KC_NO,  KC_NO,   KC_NO,  KC_NO,   KC_NO,  KC_NO,       KC_MS_BTN1,  KC_MS_BTN2,  KC_NO,
  KC_NO,   KC_NO,  KC_NO,   KC_NO,  KC_NO ,  KC_NO,  KC_WH_L,     KC_WH_D,     KC_WH_UP,    KC_WH_R,
  KC_NO,   KC_NO,  ADJUST,  KC_NO,      KC_TILD,     KC_MS_LEFT,  KC_MS_DOWN,  KC_MS_UP,    KC_MS_RIGHT
),
...
[_RAISE] = LAYOUT_ortho_4x10uC(
 ...
 `--------------------------------------------------------------------*/
  ...
  KC_NO,    ADJUST,   KC_NO,       KC_NO,            KC_NO,         KC_NO,    KC_NO,    KC_NO,    KC_NO
),
...
[_ADJUST] = LAYOUT_ortho_4x10uC(
 ...
 `--------------------------------------------------------------------*/
  ...
  KC_NO,  KC_NO,  KC_NO,  KC_NO,   KC_NO,  KC_NO,  KC_NO,    KC_NO,     KC_NO,    KC_NO,
  KC_NO,  KC_NO,  KC_NO,  KC_NO,   KC_NO,  KC_NO,  KC_NO,    KC_NO,     KC_NO,    KC_NO,
  KC_NO,  KC_NO,  KC_NO,  KC_NO,      QK_BOOT,     KC_NO,    KC_NO,     KC_NO,    KC_NO
)
